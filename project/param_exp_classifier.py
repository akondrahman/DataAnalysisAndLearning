# -*- coding: utf-8 -*-
"""
Created on Sun Apr  3 23:20:58 2016
...
def runRandomForest(trainDataParam, testDataParam):
  ...
  max_depth_list = [1,5,10, 25, None ]
  max_leaf_nodes_list = [None, 5, 10]
          ...
          for max_leaf in max_leaf_nodes_list:
            for bootstrap_ in bootstrap_list:
              for min_sample in min_samples_split_list: 
                ## fire up the model   
                theRndForestModel = RandomForestClassifier( n_estimators=eti, criterion=crit, 
                                                            max_depth=max_depth_, min_samples_split=min_sample, 
                                                            max_features=maxfeat, max_leaf_nodes=max_leaf, 
